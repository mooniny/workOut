...
for page in range(1, 3):
    con.request("GET", "/newSt/price/daily.php?p_page=%d&y1=2021&m1=02&d1=22&y2=2021&m2=07&d2=21&stCode=%s" % (page, cCode))    # 날짜 기준 잡기
    rb = con.getresponse().read()
    # print(rb)
    ssMarketData = BeautifulSoup(rb, "html.parser", from_encoding = "utf-8")
    # print(ssMarketData)
    ssMarketDatas = ssMarketData.select("table.table_3 tbody tr")
    print(ssMarketDatas)
