...
while True:
    ...
    if d < 2:
        break
# ##################################################################
# http://192.168.0.189:4433/img.what?name=test1.png
@app.route("/img.what")
def imgWhat():
    fName = request.args.get('name')
    fName = 'C:/Users/sdedu/Desktop/test/heroTest/' + fName     # http주소의 /와 겹치니까 파일은 여기서 불러와주기
    ...
    resBody = {"who":label[result[0]]}
    return make_response(jsonify(resBody))

if __name__ == '__main__':
    app.run("0.0.0.0", 4433, True)